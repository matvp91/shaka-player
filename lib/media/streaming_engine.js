...
shaka.media.StreamingEngine = class {
  ...
  forwardTimeForCrossBoundary_() {
    ...
    if (video.readyState === 0) {
      // No metadata yet (e.g. during a MediaSource reset): there is no
      // meaningful playback position to measure against. We'll be re-invoked
      // via seeked/timeupdate once the element is ready again.
      return;
    }
